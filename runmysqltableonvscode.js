...
con.connect(function (err) {
  ...
  var sql =
    "select * from farm left join farm_has_animal on farm.id=farm_has_animal.farm_id left join animal on farm_has_animal.animal_id=animal.id;";
