//ici se sont les requirement que le user doit avoir pour register et avoir acces dans notre page web
...
public class UniqueEmailAttribute : ValidationAttribute {
    protected override ValidationResult? IsValid(object? value, ValidationContext valContext) {
        ...
        if(_context.Users_regdb.Any(e => e.Email == value.ToString())) {
